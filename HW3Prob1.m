...
GPSXY=[GPS_x GPS_y]'; %this gives us a 2xnp matrix of x and y values, which we need for the matrix multiplication below.
synthL = L*GPSXY;
synthE = E*GPSXY;
synthW = W*GPSXY;
